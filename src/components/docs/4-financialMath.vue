    ...
    <v-container>
      <v-row class="d-flex align-center justify-left">
        ...
        <p>
          ...
          on a savings deposit or investment taking into account the effect of compounding interest.
        </p>
        <p>
          Unlike simple interest, compounding interest is calculated periodically and the amount is
          immediately added to the balance. With each period going forward, the account balance gets
          a little bigger, so the interest paid on the balance gets bigger as well. This makes the
        ...
        <p>
          ...
          at the current market price minus a liquidation discount ; this incentivises users to
          quickly step in to reduce the borrower’s exposure, effectively reducing the protocol’s
          risk.
        </p>
        <p>
          The proportion eligible to be closed, a close factor , is the portion of the borrowed
          asset that can be repaid, and ranges from 0 to 1, and it represents a percentage, such as
          25%
        </p>
        <p>
          ...
          and prices are all contained within the <strong>rLending protocol</strong>, liquidation is
        ...
        <p>
          ...
          used for supplying assets. Supplied collateral assets earn interest while in the protocol,
          but users cannot redeem or transfer assets while they are being used as collateral.
        </p>
        <p>
          <strong>Collateral Factor</strong> — The maximum amount users can borrow is limited by the
          <em>collateral factor</em> of the assets they have supplied. For example, if a user
          ...
          asset on <strong>rLending</strong> has a different <em>collateral factor</em>. They can be
          fetched using the Comptroller contract.
        </p>
        <p>
        ...
        <p>
          ...
          depends on the specific interest rate model smart contract implemented for the market, and
          the amount of change in the ratio of borrowed assets to supplied assets in the market.
        </p>
        <p>
        ...
        <p>
          ...
          each prior block in which the accrueInterest method was not triggered (no user interacted
          with the cToken contract). This only happens during blocks in which the cToken contract
