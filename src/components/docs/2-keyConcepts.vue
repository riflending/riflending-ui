    ...
    <v-container>
      <v-row class="d-flex align-center justify-left">
        ...
        <p>
          ...
          assets that <strong>rLending</strong> can support are rBTC and ERC-20 tokens deployed on
          RSK.
        </p>
        <p>
        ...
        <p>
          ...
          every block (currently ~30 seconds) and users can <a href="#withdrawal">withdraw</a> their
          ...
          users to borrow, and they share in the interest that borrowers pay back to the pool.
        </p>
        <p>
          ...
          interest accrues to the assets supplied, cTokens are redeemable at an exchange rate
        ...
        <p>
          ...
          a collateral factor, ranging from 0 to 1, that represents the portion of the underlying
          asset value that can be borrowed.
          <strong
        ...
        <p>
          Users are able to borrow up to, <em>but not exceeding</em>, their borrowing capacity, and
          an account can take no action (e.g. borrow, transfer cToken collateral, or redeem cToken
          collateral) that would raise the total value of borrowed assets above their borrowing
          capacity (<a href="#borrowlimit">borrow limit</a>); this protects the protocol from
          default risk.
        </p>
        <p>
          <strong>Collateral</strong> is the guarantee that users provide that allows them to borrow
          on any given market. In order to supply collateral, users must first activate the
        ...
        <p>
          ...
          interact with each cToken contract in which they wish to repay a borrow and seize another
          asset as collateral. When collateral is seized, the liquidator is transferred cTokens,
          which they may redeem the same as if they had supplied the asset themselves. Users must
        ...
        <p>
          ...
          interacting with the asset. In order to borrow an asset, there must be a valid price from
          the Price Oracle; in order to use an asset as collateral, there must be a valid price and
          a collateralFactor. Each function call is validated through a policy layer, referred to as
          <em>the Comptroller</em> ; this contract validates collateral and liquidity, before
          allowing a user action to proceed.
        </p>
        <p>
