<template>
  <div id="top" class="terms">
    <v-container>
      ...
      <v-row>
        <p>
          Below you will find legally required information, written by and for lawyers. Please read
          it carefully.
        </p>
        <hr />
        <p>
          This Privacy Statement explains how <strong>rLending</strong> collects, uses, and
          discloses information about you through its websites, including web applications, and
          other online products and services (collectively, the “Services”) or when you otherwise
          interact with us.
        </p>
        <p>
          ...
          the Services or otherwise interact with us to stay informed about our information
