      ...
      <v-col :class="colSize">
        ...
        <section>
          ...
          <p>
            ...
            suppliers. In other words: Every supply earns interests and in order to borrow an asset,
            users must first supply collateral to a market.
          </p>
          <p>
            <strong
        ...
        <section>
          ...
          <p>
            ...
            balance (<a href="#ctokens">cToken</a>), which entitles the owner to an increasing
            quantity of the underlying asset. As the money <a href="#markets">market</a> accrues
            interest, which is a function of borrowing demand, cTokens become convertible into an
        ...
        <section>
          ...
          <p>
            ...
            hood, users are contributing their assets to a large pool of liquidity (a “<a
              href="#markets"
              >market”</a
            >) that is available for other users to <a href="#borrowingAssets">borrow</a>, and they
            share in the interest that borrowers pay back to the pool.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            liquidators receive the borrower’s collateral at a 8\% discount to
            <a href="#marketPrice">market price</a>. Having your
            <a href="#account">account</a> liquidated is bad because you lose some of your
            collateral.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            <a href="#liquidation">underwater accounts</a>. For example, if the liquidation
            incentive is 1.1, liquidators receive an extra 10% of the borrowers collateral for every
            unit they close.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            time. This action performs a transaction that redeems available
            <a href="#ctokens">cTokens</a> for an the equivalent amount of underlying asset
        ...
        <section>
          ...
          <p>
            ...
            liquidation. Users with a shortfall (<em>negative liquidity</em>) are subject to
            liquidation and can’t withdraw or borrow assets until their Account Liquidity is
            positive again.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            under-collateralized (<em>negative Health Factor</em>) it runs the risk of having
        ...
        <section>
          ...
          <p>
            ...
            to use an asset as collateral, there must be a valid price and a collateralFactor. Each
            function call is validated through a policy layer, referred to as
          ...
          <ul>
            ...
            <li class="mb-4">
              The ability to withdraw the reserve of a <a href="#ctokens">cToken</a>
            </li>
