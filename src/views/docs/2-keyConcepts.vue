  ...
  <v-container>
    ...
    <section>
      ...
      <p>
        ...
        from <strong>rLending</strong> simply requires a user to specify a desired asset; there are
    ...
    <section>
      ...
      <p>
        ...
        — currently set at 8\% but subject to change through <strong>rLending</strong>’s governance
