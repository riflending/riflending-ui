  ...
  <v-container>
    ...
    <section>
      ...
      <p>
        ...
        aspects required in order to deploy on the RSK Network. Our development team, alongside
        third-party auditors and consultants, has invested considerable effort to create a protocol
        that we believe is safe and dependable. All contract code and balances are publicly
        verifiable. Developers and security researchers are eligible for a bug bounty for reporting
