      ...
      <v-col :class="colSize">
        <section>
          ...
          <p>
            ...
            areused to determine borrowing capacity, collateral requirements and for all functions
            whichrequire calculating the value equivalent of an account.
          </p>
          <p>
            Although <a href="/docs/keyConcepts#interestModel">interest rates</a> are determined by
            the balance between supply and demand, <strong>rLending</strong> relies partially on
            market prices. Since the protocol has the ability of listing dozens of markets, each
            requiring it&#39;s own Oracle with it&#39;s own set of rules,
        ...
        <section>
          ...
          <p>
            ...
            <strong>rLending</strong> does not manage any of the oracles the protocol is currently
