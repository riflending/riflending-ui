    ...
    <v-row>
      ...
      <v-col :class="colSize">
        ...
        <section>
          ...
          <p>
            <strong
              >Toggle the Collateral column to enter your supplied funds as collateral.</strong
            >
          </p>
          <p align="center">
            <v-img
          ...
          <p>
            If successful, you will receive confirmation and the borrowing warning will dissapear
            from the background.
          </p>
          <p align="center">
            <v-img
        ...
        <section>
          ...
          <p>
            ...
            <strong>49,825.61 cRIF</strong> is now equal to
            <strong>1,075.78 RIF</strong> (49,825.610.021591) You could withdraw
            ...
            which would redeem <strong>46,315.59 cRIF</strong> (keeping *3,510.01 cRIF in your
            wallet) or you could transfer your cTokens, effectively transferring your balance of
            underlying asset.
          </p>
          <p align="center">
            <v-img
          ...
          <p>
            If you send your cTokens to a friend, your <strong>rLending</strong> balance will
            decline and your friend&#39;s will increase.
            <strong
        ...
        <section>
          <h2 id="integration">rLending and the RSK ecosystem:</h2>
          <p>
          ...
          <p>
            ...
            from the
            <strong>rLending Protocol</strong> Then it would be possible to use the
