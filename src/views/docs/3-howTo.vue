<template>
  <v-container>
    ...
    <section>
      ...
      <p>
        <strong>rLending</strong> deposits are easy! After you have connected your Metamask or Nifty
    ...
    <section>
      ...
      <p>
        <strong>rLending</strong> runs on the <a href="https://www.rsk.co/">RSK Network</a> but it
      ...
      <p>
        For example, let's say a user holding rBTC wants to buy USDT. This is possible, by supplying
        rBTC as collateral and borrowing rKovUSDT(the pegged token in the RSK network) from the
