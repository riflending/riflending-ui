  ...
  <v-container>
    ...
    <section>
      ...
      <p>
        ...
        <strong>rLending</strong> Protocol; when a user mints, redeems, borrows, repays a borrow,
      ...
      <p>
        ...
        itself. As such, the core functions which involve transferring an asset into the protocol
        have slightly different interfaces depending on the type, each of which is shown below.
      </p>
      <p>
        ...
        increases over time. There is no minimum or maximum amount of time that suppliers need to
        keep their asset in the protocol. See the varying exchange rate for each cToken by clicking
        selecting one from the list at
    ...
    <section>
      ...
      <ul>
        ...
        <li class="mb-4">Comptroller (logic only): 0x2e64b3acd75d86a8Ff17B98e02dAe4dCf2852a94</li>
        <li class="mb-4">
          JumpRateModelV2:
          <a
