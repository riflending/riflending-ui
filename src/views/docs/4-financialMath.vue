      ...
      <v-col :class="colSize">
        <section>
          ...
          <p>
            ...
            InterestRate Index, which is calculated every time an interest rate changes resulting
        ...
        <section>
          ...
          <ul>
            ...
            <li class="mb-4">
              ...
              asideas liquidity which can be withdrawn or transferred. Reserves are a small portion
              ofborrower interest accrues into the protocol, determined by the reserve factor.
            </li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            isimmediately added to the balance. With each period going forward, the account balance
            gets a little bigger, so the interest paid on the balance gets bigger as well. This
            makes the
            <strong>rLending Protocol</strong> a better alternative than other platforms that rely
            onsimple interest rates.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            portionof the outstanding borrowing may be repaid in exchange for the user’s cToken
          ...
          <p>
            ...
            assetthat can be repaid, and ranges from 0 to 1, and it represents a percentage, such as
            25%
          </p>
          <p>
            ...
            andprices are all contained within the <strong>rLending protocol</strong>, liquidation
        ...
        <section>
          ...
          <p>
            ...
            <strong>rLending</strong> protocol, users need to first supply them as collateral. This
            isprovided using the same mint function used for supplying assets. Supplied collateral
          ...
          <p>
            ...
            supplies100 USDT as collateral and the posted <em>collateral factor</em> for USDT is
          ...
          <p>
            ...
            factorthen it can&#39;t be used as collateral (or seized in liquidation), though it can
            still be borrowed.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            interactswith the market’s cToken contract, calling one of these functions:
          </p>
          <ul>
          ...
          <p>
            ...
            eachprior block in which the accrueInterest method was not triggered (no user interacted
          ...
          <p>
            ...
            thesupplyRatePerBlock is <strong>37893605 Wei</strong>, or
