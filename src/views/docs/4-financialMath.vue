    ...
    <v-container>
      <v-row class="d-flex align-center justify-left">
        <v-col cols="12">
          ...
          <p>
            <strong>rLending</strong> markets are defined by an interest rate equation, applied to
            all borrowers uniformly, which adjust over time as the relationship between supply and
            demand evolves.
          </p>
          <p>
          ...
          <p>
            ...
            and prices are all contained within the <strong>rLending protocol</strong>, liquidation
          ...
          <p>
            ...
            depends on the specific interest rate model smart contract implemented for the market,
            and the amount of change in the ratio of borrowed assets to supplied assets in the
            market.
          </p>
          <p>
